...
const Header = () => {
  ...
  const [input, setInput] = useState(parsedQuery.keywords || "");
  const handleInputSearch = (e) => {
    if (e.key === "Enter" && e.target.value) {
      navigate(`/search?keywords=${e.target.value}`);
    }
  };
      ...
      <div className={styles.container}>
        <Link to="/">
          <svg
            ...
            aria-hidden="true"
          >
            <rect fill="#AE4347" width="100%" height="100%"></rect>
            <path
              fill="#FEFEFE"
            ...
            ></path>
            <path fill="#AE4347" d="M0 0h30v52H0z"></path>
            <path
              fill="#FEFEFE"
